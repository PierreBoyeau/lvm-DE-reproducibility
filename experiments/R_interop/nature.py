...
class DEClass:
    def __init__(
        ...
        print("set_a {}, self.A {}".format(len(set_a), self.A))
        ...
        print("Intersecting data {}".format((self.c_train == self.cluster[1]).sum()))
        print("set_b {}, self.B {}".format(len(set_b), self.B))
